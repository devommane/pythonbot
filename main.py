...
BOT_TOKEN = "6424551029:AAEYrkvbxzoZleUgDt8jZUiIouamQk-eqLA"
PAYMENT_CHANNEL = "@dfdggdgdf" #add payment channel here including the '@' sign
OWNER_ID = 6358212605 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@dfdggdgdf"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
